package com.qew032.section03.sqlinjection;

import java.sql.*;

import static com.qew032.common.JDBCTemplate.close;
import static com.qew032.common.JDBCTemplate.getConnection;
...
public class Application2 {
    public static void main(String[] args) {
        ...
        // DB 연결 객체
        Connection con = null;
        // SQL 전달, 수행 결과 받아오는 객체
        PreparedStatement pstmt = null;
        // SELECT 수행 결과를 얻어와 저장하는 객체
        ResultSet rset = null;
        ...
        try {
            ...
            String sql = "select * from tbl_menu where menu_code = ? and menu_name = ?";
